        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommentByUserId1 = table.Column<int>(type: "int", nullable: true),
                    CommentRlyToId = table.Column<long>(type: "bigint", nullable: true),
                    CommentRlyToId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_blogComments_AspNetUsers_CommentByUserId1",
                        column: x => x.CommentByUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_blogComments_AspNetUsers_CommentRlyToId1",
                        column: x => x.CommentRlyToId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikedByUserId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogLikes", x => new { x.BlogId, x.LikedByUserId });
                    table.ForeignKey(
                        name: "FK_BlogLikes_AspNetUsers_LikedByUserId1",
                        column: x => x.LikedByUserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_blogComments_CommentByUserId1",
                table: "blogComments",
                column: "CommentByUserId1");

            migrationBuilder.CreateIndex(
                name: "IX_blogComments_CommentRlyToId1",
                table: "blogComments",
                column: "CommentRlyToId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogLikes_LikedByUserId1",
                table: "BlogLikes",
                column: "LikedByUserId1");
